...
<body class="font-sans antialiased bg-gray-50 text-gray-800">
    ...
    @if(!empty($storeSetting->wa_numbers) && count($storeSetting->wa_numbers) > 0)
        <a href="https://api.whatsapp.com/send?phone={{ $storeSetting->wa_numbers[0] }}" target="_blank" rel="noopener noreferrer" class="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg transition-transform hover:scale-110" aria-label="Chat via WhatsApp">
